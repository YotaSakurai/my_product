...
unsigned char Sec1=0;			//ラップタイム1
unsigned char Sec2=0;			//ラップタイム2
unsigned char Sec3=0;			//ラップタイム3
...
void Display(void)
{
	...
	if(input_buffer[1] == 0x31){
		...
		lcd_cmd(0xC0);									//2行目へ
		sprintf(Msg6,"%2d.%01dA/F %4d",(74 + (150*AF)/248)/10,(74 + (150*AF)/250)%10,Rev);	
		...
		lcd_cmd(0xD4);	//4行目へ
		sprintf(Msg4," %2d.%01dV     %2d>%02d:%02d'",Voltage/51,(Voltage%51)*10/51,R3,Sec3/60,Sec3%60);
